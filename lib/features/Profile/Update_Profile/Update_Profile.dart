...
import 'package:movies/features/Profile/Widgets/Custom_Elevated_Button.dart';
import 'package:movies/features/Profile/Widgets/Custom_Info_Preview.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
         ...
         InfoPreview(name: "John Safwat",icon: Person_icon,),
         InfoPreview(name: "01200000000",icon: Phone_icon,),
